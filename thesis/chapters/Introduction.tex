...
\begin{itemize}
    ...
    \item \textbf{\Cref{chap:DesignAndMethodology}} details the design and implementation of the Arralac language, covering its pipeline from parsing to typechecking and evaluation, with a focus on the architectural decisions made.
