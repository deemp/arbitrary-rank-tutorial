...
data HappyAbsSyn 
        ...
        | HappyAbsSyn25 ((Language.STLC.Syntax.Abs.BNFC'Position, Integer))
        | HappyAbsSyn26 ((Language.STLC.Syntax.Abs.BNFC'Position, String))
        ...
        | HappyAbsSyn31 ((Language.STLC.Syntax.Abs.BNFC'Position, Language.STLC.Syntax.Abs.Con))
        | HappyAbsSyn32 ((Language.STLC.Syntax.Abs.BNFC'Position, Language.STLC.Syntax.Abs.Bool))
        | HappyAbsSyn33 ((Language.STLC.Syntax.Abs.BNFC'Position, Language.STLC.Syntax.Abs.Exp))
        | HappyAbsSyn43 ((Language.STLC.Syntax.Abs.BNFC'Position, Language.STLC.Syntax.Abs.Type))
        | HappyAbsSyn46 ((Language.STLC.Syntax.Abs.BNFC'Position, Language.STLC.Syntax.Abs.TypeVariable))
        | HappyAbsSyn48 ((Language.STLC.Syntax.Abs.BNFC'Position, [Language.STLC.Syntax.Abs.TypeVariable]))
...
happyReduction_27 (HappyAbsSyn28  happy_var_1)
         =  HappyAbsSyn31
                 ((Language.STLC.Syntax.Abs.spanBNFC'Position (fst happy_var_1) (fst happy_var_1), Language.STLC.Syntax.Abs.Con (Language.STLC.Syntax.Abs.spanBNFC'Position (fst happy_var_1) (fst happy_var_1)) (snd happy_var_1))
        )
...
happyReduction_28 (HappyTerminal happy_var_1)
         =  HappyAbsSyn32
                 ((Language.STLC.Syntax.Abs.spanBNFC'Position (uncurry Language.STLC.Syntax.Abs.BNFC'Position (tokenSpan happy_var_1)) (uncurry Language.STLC.Syntax.Abs.BNFC'Position (tokenSpan happy_var_1)), Language.STLC.Syntax.Abs.BoolTrue (Language.STLC.Syntax.Abs.spanBNFC'Position (uncurry Language.STLC.Syntax.Abs.BNFC'Position (tokenSpan happy_var_1)) (uncurry Language.STLC.Syntax.Abs.BNFC'Position (tokenSpan happy_var_1))))
        )
...
happyReduction_33 (HappyAbsSyn32  happy_var_1)
         =  HappyAbsSyn33
                 ((Language.STLC.Syntax.Abs.spanBNFC'Position (fst happy_var_1) (fst happy_var_1), Language.STLC.Syntax.Abs.ExpBool (Language.STLC.Syntax.Abs.spanBNFC'Position (fst happy_var_1) (fst happy_var_1)) (snd happy_var_1))
        )
...
happyReduction_34 (HappyAbsSyn31  happy_var_1)
         =  HappyAbsSyn33
                 ((Language.STLC.Syntax.Abs.spanBNFC'Position (fst happy_var_1) (fst happy_var_1), Language.STLC.Syntax.Abs.ExpCon (Language.STLC.Syntax.Abs.spanBNFC'Position (fst happy_var_1) (fst happy_var_1)) (snd happy_var_1))
        )
