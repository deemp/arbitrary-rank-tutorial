...
Each step of the pipeline works with at most two different AST representation.

### Parser/Generated/Abs

[Parser/Generated/Abs](arralac/src/Language/Arralac/Parser/Generated/Abs.hs) is used by `Parser` and `Renamer`.
...
On the one hand, data types become extremely flexible and reusable. On the other hand, there appears a significant overhead in terms of lines of code written to define type family instances.
