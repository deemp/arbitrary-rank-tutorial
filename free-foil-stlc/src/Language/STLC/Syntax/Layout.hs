...
module Language.STLC.Syntax.Layout where
...
layoutWords = [( TokSymbol "where" 17
               , LayoutDelimiters (TokSymbol ";" 10) (Just (TokSymbol "{" 18)) (Just (TokSymbol "}" 20))
               )]
...
layoutSep   = List.nub $ TokSymbol ";" 10 : map (delimSep . snd) layoutWords
...
resolveLayout topLayout =
  ...
  topDelim = LayoutDelimiters (TokSymbol ";" 10) Nothing Nothing
