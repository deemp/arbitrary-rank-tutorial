...
module Language.ModularSTLC.Syntax.Layout where
...
layoutWords = [( TokSymbol "where" 25
               , LayoutDelimiters (TokSymbol ";" 13) (Just (TokSymbol "{" 26)) (Just (TokSymbol "}" 28))
               )]
...
parenOpen  = [TokSymbol "(" 5]
parenClose = [TokSymbol ")" 6]
